...
public class UserOrderService {
    ...
    public List<UserOrderEntity> getUserOrderList(Long userId, UserOrderStatus userOrderStatus){
        return userOrderRepository.findAllByUserIdAndStatusOrderByIdDesc(userId, userOrderStatus);
    }
